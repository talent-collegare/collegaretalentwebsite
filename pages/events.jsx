  ...
  return (
    <section style={{ padding: '160px var(--gutter) 0', borderBottom: '1px solid var(--line)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 6 }}>
        <img src={REAL_PHOTOS.eventHero[0]} alt="" style={{ width: '100%', aspectRatio: '4/5', objectFit: 'cover' }}/>
        <img src={REAL_PHOTOS.eventHero[1]} alt="" style={{ width: '100%', aspectRatio: '4/5', objectFit: 'cover' }}/>
        <img src={REAL_PHOTOS.eventHero[2]} alt="" style={{ width: '100%', aspectRatio: '4/5', objectFit: 'cover' }}/>
      </div>
    </section>
  );
}
