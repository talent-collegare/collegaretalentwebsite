  ...
  return (
    <section style={{ padding: '160px var(--gutter) 0', borderBottom: '1px solid var(--line)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.6fr 1fr 1fr', gap: 8, marginBottom: 0 }}>
        <img src={REAL_PHOTOS.events[0]} alt="" style={{ width: '100%', aspectRatio: '4/3', objectFit: 'cover' }}/>
        <img src={REAL_PHOTOS.events[1]} alt="" style={{ width: '100%', aspectRatio: '4/3', objectFit: 'cover' }}/>
        <img src={REAL_PHOTOS.events[2]} alt="" style={{ width: '100%', aspectRatio: '4/3', objectFit: 'cover' }}/>
      </div>
    </section>
  );
}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: 80, alignItems: 'start' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 40 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, margin: '20px 0' }}>
            <img src={REAL_PHOTOS.events[3]} alt="" style={{ width: '100%', aspectRatio: '4/5', objectFit: 'cover' }}/>
            <img src={talentAt(0)} alt="" style={{ width: '100%', aspectRatio: '4/5', objectFit: 'cover' }}/>
          </div>
          <p style={{ fontSize: 17, lineHeight: 1.7, color: 'var(--ink-soft)' }}>
  ...
  return (
    <section style={{ padding: 'var(--section) var(--gutter)' }}>
      ...
      <div style={{ marginBottom: 60 }}>
        <img src={REAL_PHOTOS.team.candid} alt="" style={{ width: '100%', aspectRatio: '16/7', objectFit: 'cover' }}/>
